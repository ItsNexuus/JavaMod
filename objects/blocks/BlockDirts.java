...
import TheNexus.interfaces.IMetaName;
...
public class BlockDirts extends Block implements IMetaName, IHasModel {
	...
	public void registerModels() {
		for(int i = 0; i < EnumHandler.EnumType.values().length; i++) {
			TheNexus.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "dirt_" + EnumHandler.EnumType.values()[i].getName(), "inventory");
		}
	}
